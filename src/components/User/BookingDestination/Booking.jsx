...
export default function Booking() {
    ...
    console.log(destination,"districtNamedistrictName");
    

    const [bookingdata,setbbokingdata]=useState(destination)
      ...
      <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      ...
                      <div className="p-2 border border-gray-300 rounded-md bg-gray-100">
                        <p className="text-gray-800">{bookingdata.state.statename}</p>
                      </div>
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">District</label>
                      <div className="p-2 border border-gray-300 rounded-md bg-gray-100">
                        <p className="text-gray-800">{bookingdata.state.districtname}</p>
                      </div>
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">Destination</label>
                      <div className="p-2 border border-gray-300 rounded-md bg-gray-100">
                        <p className="text-gray-800">{bookingdata.destination}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="p-2 border border-gray-300 rounded-md bg-gray-100">
                      <p className="text-gray-800">{bookingdata.duration}</p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="p-2 border border-gray-300 rounded-md bg-gray-100">
                      <p className="text-gray-800">₹{bookingdata.ticketPrice}</p>
                    </div>
                  </div>
            ...
            <span className='text-green-500 font-semibold'>Wallet Amount:</span>₹1200
            </div>
