...
import { finddestinations } from "../../../configure/admin";
...
export default function Destinations() {
  ...
  return (
    <div>
      <div className="container mt-5 ml-28">
        ...
        <div className="flex justify-between mt-5">
          ...
          <div className="mt-4 mr-2">
            <Link to="/admin/addstates">
              <button className="bg-black w-40 h-10 rounded-md text-green-300 font-bold hover:bg-blue-500 hover:text-white">
                Add Destinations
              </button>
            </Link>
          </div>
